...
# Instale a última versão do R no (seu) computador usado para resolução desta lista.
#Crie um script chamado solucao-q10-NomeDoAluno.R contendo os códigos gerados para solução das questões 7 e 8.
#Faça as seguintes alterações no código do script:

temp <- 30
ur <- 30

tw <- tar * atan(0.151977 * (ur + 8.313659)^(1/2)) + atan(tar + ur) - atan(ur - 1.676331) 
...
murchap <- 0.214008 + 0.0862945 * z13
murchap
